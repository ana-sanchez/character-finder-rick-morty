        ...
        return <div className='wrapper'>
            ...
            <div className="detail">
                ...
                <div className="detail__assets" >
                    ...
                    <p className="detail__assets--status"><span className='detail__assets--subtitle'>Status:</span> {character.status === 'Alive' ? <Icon style={{ fontSize: 15 }}>favorite</Icon> : <Icon style={{ fontSize: 15 }}>highlight_off</Icon>} </p>
